;------------------------------------------------------------------------------------------
; NSIS Installation script for 32/64 bit MergeTS
; bb - sdtp - March 2024
;------------------------------------------------------------------------------------------
...
!define source_dir "${lazarus_dir}\mergets"; generic program name suffix, then use ${prog_name} constant
!define prog_name "mergets"
...
!define MUI_LANGDLL_REGISTRY_KEY "Software\SDTP\mergets"
...
LangString RemoveStr ${LANG_ENGLISH}  "Merge TS"
LangString RemoveStr ${LANG_FRENCH} "Fusion de fichiers TS"

;Language string for links
LangString ProgramLnkStr ${LANG_ENGLISH} "Merge TS.lnk"
LangString ProgramLnkStr ${LANG_FRENCH} "Fusion de fichiers TS.lnk"
LangString UninstLnkStr ${LANG_ENGLISH} "Merge TS uninstall.lnk"
LangString UninstLnkStr ${LANG_FRENCH} "Désinstallation de Fusion de fichiers TS.lnk"
LangString ProgramDescStr ${LANG_ENGLISH} "Merge TS"
LangString ProgramDescStr ${LANG_FRENCH} "Fusion de fichiers TS"
LangString ShortcutDescStr ${LANG_ENGLISH} "Join files created by DVB adapters"
LangString ShortcutDescStr ${LANG_FRENCH} "Fusionne des fichiers crés par des adaptateurs DVB"
...
VIAddVersionKey "ProductName" "Installmergets.exe"
VIAddVersionKey "FileDescription" "Merge TS Installer"
